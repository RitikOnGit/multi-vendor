    ...
    <div class="iq-sidebar  sidebar-default ">
        <div class="iq-sidebar-logo d-flex align-items-center">
            <a href="index.html" class="header-logo">
                <h3 class="logo-title light-logo">Myshop</h3>
            </a>
            ...
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    @elseif(Auth::user() && Auth::user()->role === 'vendor')
                        ...
                        <li class="{{ request()->routeIs('vendor.orders.index') ? 'active' : '' }}">
                            <a href="{{ route('vendor.orders.index') }}" class="svg-icon">
                                <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <polyline points="6 9 6 2 18 2 18 9"></polyline>
        ...
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                    ...
                    <a href="index.html" class="header-logo">
                        <h4 class="logo-title text-uppercase">Myshop</h4>
                        ...
                        <ul class="navbar-nav ml-auto navbar-list align-items-center">
                            ...
                            <li class="nav-item nav-icon dropdown caption-content">
                                <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center"
                                    ...
                                    aria-expanded="false">
                                    <img src="{{ asset('admin/images/user/1.jpg') }}" class="img-fluid rounded-circle"
                                        alt="user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right border-none"
                                    ...
                                    <li class="dropdown-item d-flex svg-icon">
                                        ...
                                        <a
                                            href="https://templates.iqonic.design/product/lite/webkit/html/app/user-profile.html">My
                                            Profile</a>
                                    </li>
                                    <li class="dropdown-item d-flex svg-icon">
                                        ...
                                        <a
                                            href="https://templates.iqonic.design/product/lite/webkit/html/app/user-profile-edit.html">Edit
                                            Profile</a>
                                    </li>
                                    <li class="dropdown-item d-flex svg-icon">
                                        ...
                                        <a
                                            href="https://templates.iqonic.design/product/lite/webkit/html/app/user-account-setting.html">Account
                                            Settings</a>
                                    </li>
                                    <li class="dropdown-item d-flex svg-icon">
                                        ...
                                        <a
                                            href="https://templates.iqonic.design/product/lite/webkit/html/app/user-privacy-setting.html">Privacy
                                            Settings</a>
                                    </li>
